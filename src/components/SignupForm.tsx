...
const SignupForm: React.FC = () => {
  ...
  return (
    <section id="signup" className="py-24 bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-white text-3xl md:text-5xl font-bold uppercase tracking-tight mb-8 text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl leading-relaxed mb-12 text-center">
            Be among the first to experience the future of the creative economy.
            Early access opens soon.
          </p>
          
          {isSubmitted ? (
            <div className="bg-gradient-to-r from-pink-500/20 via-purple-500/20 to-cyan-500/20 backdrop-blur-sm p-12 text-center">
              <h3 className="text-white text-2xl font-bold mb-4">YOU'RE IN!</h3>
              <p className="text-white/80 text-lg">
                Thank you for joining our waitlist. We'll be in touch soon with early access details.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-pink-500/20 via-purple-500/20 to-cyan-500/20 blur-md"></div>
